...
export default class SessionRepository {
    async getSession(sessionId) {
        const response = await fetch(`${process.env.REACT_APP_API_URL}/api/sessions/${sessionId}/user/14907CD3-531F-4807-A458-FD6668FFFD19`, { method: 'GET' });
    ...
    enableAnswersOfTheCurrentQuestion(sessionId) {
        fetch(`${process.env.REACT_APP_API_URL}/api/sessions/EnableAnswersOfTheCurrentQuestion/${sessionId}/user/91E4AFD5-A3AF-40C1-8C54-A5829063BBCA`, { method: 'PUT' });
    }
}